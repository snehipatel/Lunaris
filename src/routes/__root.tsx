...
import { StepNav } from "@/components/mission-ui";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CH-2 South Pole Ice Screening" },
      {
        name: "description",
        content:
          "Chandrayaan-2 DFSAR + OHRC screening of lunar south polar doubly shadowed craters for subsurface water ice.",
      },
